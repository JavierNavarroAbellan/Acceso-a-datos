...
public class AccesoUsuarios {
    ...
    private static void escribirRegistro(RandomAccessFile raf, String data) throws
            IOException {
    ...
    private static void mostrarContenido(RandomAccessFile raf) throws
            IOException {
